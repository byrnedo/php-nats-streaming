...
/**
 * Protobuf message : pb.SubscriptionRequest
 */
class SubscriptionRequest extends \Protobuf\AbstractMessage
{
     ...
     *
     * @param \pb\StartPosition $value
     */
    public function setStartPosition(\pb\StartPosition $value = null)
    {
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 10) {
                ...
                $this->startPosition = \pb\StartPosition::valueOf($reader->readVarint($stream));
    ...
    {
        if ( ! $message instanceof \pb\SubscriptionRequest) {
