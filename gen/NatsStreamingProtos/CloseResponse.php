...
/**
 * Protobuf message : NatsStreamingProtos.CloseResponse
 */
class CloseResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \NatsStreamingProtos\CloseResponse) {
