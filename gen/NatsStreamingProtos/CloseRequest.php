...
/**
 * Protobuf message : NatsStreamingProtos.CloseRequest
 */
class CloseRequest extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \NatsStreamingProtos\CloseRequest) {
